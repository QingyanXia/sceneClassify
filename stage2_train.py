...
from models.cnn_bn_dropout import CNNWithBNDropout   # 注意导入
...
def main():
    ...
    print(f"模型参数量: {total_params}")   # 相比阶段一略有增加（BN层带来的参数）
    ...
    model, history = train_model(
        ...
        save_path='checkpoints/stage2_best.pth'
    )
    ...
    # 保存结果
    np.savez('experiments/stage2_results.npz',
             history=history,
             test_acc=test_acc,
             cm=cm,
