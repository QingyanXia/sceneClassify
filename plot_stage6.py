...
# 加载阶段六结果
data = np.load('experiments/stage6_se_results.npz', allow_pickle=True)
...
axes[2].set_title(f'Confusion Matrix (Test Acc: {test_acc:.2%})')

plt.tight_layout()
plt.savefig('experiments/stage6_combined.png', dpi=150)
print("图像已保存至 experiments/stage6_combined.png")
plt.show()